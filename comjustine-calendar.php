...
<!-- {% include header.html %} -->
    ...
    <div class="container single-work" id="single-cj-calendar">
        <header>
            <h1>Com'Justine</h1>
            <p>L'agence de communication souhaitait offrir un calendrier de l'avant pour ses clients. Alors que j'étais auto-entrepreneur, elle m'a passé commande pour le réaliser.</p>
        </header>

        <article class="single-work-presentation">
            <picture>
                <source srcset="img/single-cj_calendar-mockup-md.jpg" media="(min-width: 769px)">
                <source srcset="img/single-cj_calendar-mockup-sm.jpg" media="(min-width: 482px)">
                <img src="img/single-cj_calendar-mockup.jpg" alt="Com'Justine calendrier">
            </picture>
        </article>
