...
<!-- {% include header.html %} -->
    ...
    <div class="container single-work" id="single-europa_cantat">
        <header>
            <h1>Europa Cantat Junior</h1>
            <p>L'événement de chorale international Europa Cantat Junior se produit tous les 4 ans dans une ville européenne différente. Nous avons proposé, à la suite d'un travail de groupe, une identité visuelle complète.</p>
        </header>

        <article class="single-work-presentation">
            <picture>
                <source srcset="img/single-europa_cantat-flyer-md.jpg" media="(min-width: 769px)">
                <source srcset="img/single-europa_cantat-flyer-sm.jpg" media="(min-width: 482px)">
                <img src="img/single-europa_cantat-flyer.jpg" alt="Europa Cantat Junior - Flyer mockup">
            </picture>
            <picture>
                <source srcset="img/single-europa_cantat-apple_devices-md.jpg" media="(min-width: 769px)">
                <source srcset="img/single-europa_cantat-apple_devices-sm.jpg" media="(min-width: 482px)">
                <img src="img/single-europa_cantat-apple_devices.jpg" alt="Europa Cantat Junior - Apple mockup">
            </picture>
        </article>
