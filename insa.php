...
<!-- {% include header.html %} -->
    ...
    <div class="container single-work" id="single-insa">
        <header>
            <h1>INSA</h1>
            <p>L'INSA organise un festival annuel : "Les 24h de l'INSA". Lorsque que j'étais en DUCCI2, nous avons créé une identité visuelle en binôme pour tous les supports de communication de l'événement.</p>
        </header>

        <article class="single-work-presentation">
            <picture>
                <source srcset="img/single-insa-mockup-md.jpg" media="(min-width: 769px)">
                <source srcset="img/single-insa-mockup-sm.jpg" media="(min-width: 482px)">
                <img src="img/single-insa-mockup.jpg" alt="identité visuelle INSA - Mockups">
            </picture>
        </article>
